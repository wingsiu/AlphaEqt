...
try {
  ...
  Font.load({
    'LM-M': ['fonts/latinmodern-math.otf', charOptions],
    'LM-R': ['fonts/lmroman10-regular.otf', charOptions],
    'LM-B': ['fonts/lmroman10-bold.otf', charOptions],
    'LM-I': ['fonts/lmroman10-italic.otf', charOptions],
    'LM-BI': ['fonts/lmroman10-bolditalic.otf', charOptions],
    'LM-SS': ['fonts/lmsans10-regular.otf', charOptions],
    'LM-SSB': ['fonts/lmsans10-bold.otf', charOptions],
    'LM-SSI': ['fonts/lmsans10-oblique.otf', charOptions],
    'LM-SSBI': ['fonts/lmsans10-boldoblique.otf', charOptions],
    'LM-T': ['fonts/lmmono10-regular.otf', charOptions],
    'OLD-R': ['../subsets/CM-OldStyle-Regular.otf', charOptions],
    'OLD-B': ['../subsets/CM-OldStyle-Bold.otf', charOptions],
  ...
  //
  Font.get('LM-M')
    .addGlyph(Font.buildV('LM-M', [0x23AD, 0x23A7], 0x23B0, 'lmoustache', -500))
    .addGlyph(Font.buildV('LM-M', [0x23A9, 0x23AB], 0x23B1, 'rmoustache', -500))
    .addGlyph(Font.buildV('LM-M', [[0x21BE, 'tp']], 0x294C, 'uni294C.tp', 0, 175))
    .addGlyph(Font.buildV('LM-M', [[0x21BF, 'tp']], 0x294D, 'uni294D.tp', 0, 0, 175))
    .addGlyph(Font.buildV('LM-M', [[0x21C3, 'bt']], 0x294C, 'uni294C.bt', 0, 0, 175))
    .addGlyph(Font.buildV('LM-M', [[0x21C2, 'bt']], 0x294D, 'uni294D.bt', 0, 175))
    .addGlyph(Font.buildV('LM-M', [[0x2191, 'ex']], 0x294C, 'uni294C.ex', 0, 58, 58))
    .addGlyph(Font.buildV('LM-M', [0x221A], 0x221A, 'uni221A.tv', 710))
    .addGlyph(Font.buildH('LM-M', [[0x21BC, 'lft'], [0x21C1, 'rt']], 0x294A, 'uni294A'))
    .addGlyph(Font.buildH('LM-M', [[0x21BD, 'lft'], [0x21C0, 'rt']], 0x294B, 'uni294B'))
    .addGlyph(Font.buildV('LM-M', [[0x294C, 'bt' ], [0x294C, 'tp']], 0x294C, 'uni294C'))
    .addGlyph(Font.buildV('LM-M', [[0x294D, 'bt' ], [0x294D, 'tp']], 0x294D, 'uni294D'))
    .addGlyph(Font.buildH('LM-M', [[0x21BC, 'lft'], [0x21C0, 'rt']], 0x294E, 'uni294E'))
    .addGlyph(Font.buildV('LM-M', [[0x294D, 'bt' ], [0x294C, 'tp']], 0x294F, 'uni294F'))
    .addGlyph(Font.buildH('LM-M', [[0x21BD, 'lft'], [0x21C1, 'rt']], 0x2950, 'uni2950'))
    .addGlyph(Font.buildV('LM-M', [[0x294C, 'bt' ], [0x294D, 'tp']], 0x2951, 'uni2951'))
    .addGlyph(Font.buildH('LM-M', [[0x21BC, 'lft'], [0x21A4, 'rt']], 0x295A, 'uni295A'))
    .addGlyph(Font.buildH('LM-M', [[0x21A6, 'lft'], [0x21C0, 'rt']], 0x295B, 'uni295B'))
    .addGlyph(Font.buildV('LM-M', [[0x21A5, 'bt' ], [0x294C, 'tp']], 0x295C, 'uni295C'))
    .addGlyph(Font.buildV('LM-M', [[0x294D, 'bt' ], [0x21A7, 'tp']], 0x295D, 'uni295D'))
    .addGlyph(Font.buildH('LM-M', [[0x21BD, 'lft'], [0x21A4, 'rt']], 0x295E, 'uni295E'))
    .addGlyph(Font.buildH('LM-M', [[0x21A6, 'lft'], [0x21C1, 'rt']], 0x295F, 'uni295F'))
    .addGlyph(Font.buildV('LM-M', [[0x21A5, 'bt' ], [0x294D, 'tp']], 0x2960, 'uni2960'))
    .addGlyph(Font.buildV('LM-M', [[0x294C, 'bt' ], [0x21A7, 'tp']], 0x2961, 'uni2961'))
  ;
  ...
  //
  CHARSET.Ops = CHARS.At(0x2A09).feature('v1').plus(
    CHARS.InRange(0x2190, 0x21FF, 'LM-M', 'v1'),   // arrows
    ...
    CHARS.InRange(0x2B00, 0x2B3F, 'LM-M', 'v1'),   // more arrows
  );

  CHARSET.Arrows = CHARS.InRange(0x2190, 0x21FF, 'LM-M', 'h1').plus(
    CHARS.At(0x27A1).feature('h1'),
    CHARS.InRange(0x2B00, 0x2B3F, 'LM-M', 'h1')
  );
  ...
  //
  CHARSET.NonNormal = CHARS.At(0xA0).plus(CHARSET.Alpha, CHARSET.Numbers, CHARSET.Greek, CHARSET.Dotless);
  ...
  //
  // The MathJaxModern variants
  //
  const MathJaxModernVariants = Variants.define({
    normal: [
      ['LM-M', [
        CHARS.InRange(0x20, 0x4000, 'LM-M').minus(
          CHARS.At(0x2061),       // there is a visible glyph at this location (should be variant form)
          CHARSET.MathScript,     // these are calligraphic
          CHARSET.MathBoldScript  // these are bold calligraphic
        ).minus(CHARS.At(0x275A)),
        CHARSET.SpacingAccents,
        CHARS.Map({
          0x25B4: 0x25B2, 0x25B5: 0x25B3,  // match triangles as in v2 MathJax TeX fonts
          0x25B8: 0x25B6, 0x25B9: 0x25B7,
          0x25BE: 0x25BC, 0x25BF: 0x25BD,
          0x25C2: 0x25C0, 0x25C3: 0x25C1,
          0x25FB: 0x25A1, 0x25FC: 0x25A0,  // match squares as in v2 MathJax TeX fonts
          0x2758: 0x275A,         // move vertical bar
          0x29F6: 0x5C, 0x29F9: 0x5C, // large reverse solidus
          0x29F8: 0x2F,               // large solidus
        }),
        CHARS.InRange(0xE000, 0xFEFF, 'LM-M'),
        CHARS.InRange(0x1D400, 0x1D7FF, 'LM-M').minus(
          CHARSET.MathScript,     // these are calligraphic
          CHARSET.MathBoldScript  // these are bold calligraphic
        )
      ]],
      ['LM-R', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-R').minus(CHARS.InRange(0x20, 0x2FFF, 'LM-M')),
        CHARS.InRange(0xE000, 0xFEFF, 'LM-R').minus(CHARS.InRange(0xE000, 0xFEFF, 'LM-M'))
      ]],
      ['SCR-R', [CHARSET.MathScript]],
      ['SCR-B', [CHARSET.MathBoldScript]],
      ['EXTRA', [CHARS.InRange(0x2000, 0x3000, 'EXTRA').minus(CHARSET.TeXVariant)]]
    ],
    bold: [
      ['LM-M', [
      ...
      ['LM-B', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-B').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-B'),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    italic: [
      ...
      ['LM-I', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-I').minus(CHARSET.NonNormal).plus(CHARSET.Numbers),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-I'),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    'bold-italic': [
      ...
      ['LM-BI', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-BI').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-BI'),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    ...
    'sans-serif': [
      ...
      ['LM-SS', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-SS').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-SS'),
        CHARSET.GreekUC.minus(CHARS.At(0x3F4)),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    'bold-sans-serif': [
      ...
      ['LM-SSB', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-SSB').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-SSB'),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    'sans-serif-italic': [
      ...
      ['LM-SSI', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-SSI').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-SSI'),
        CHARSET.Numbers,
        CHARSET.GreekUC.minus(CHARS.At(0x3F4)),
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
    ...
    'sans-serif-bold-italic': [
      ...
      ['LM-SSBI', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-SSBI').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-SSBI'),
        CHARSET.Numbers,
        CHARSET.SpacingAccents,
        CHARS.Map({0xA0: 0x20}),
      ]]
    ...
    'monospace': [
      ...
      ['LM-T', [
        CHARS.InRange(0x20, 0x2FFF, 'LM-T').minus(CHARSET.NonNormal),
        CHARS.InRange(0xE800, 0xFEFF, 'LM-T'),
        CHARSET.GreekUC.minus(CHARS.At(0x3F4)),
        CHARS.Map({0xA0: 0x20}),
      ]]
    ],
    '-smallop': ['LM-M', [
      CHARS.ForFeature('v1', 'LM-M').minus(CHARSET.Ops, CHARSET.Arrows, CHARSET.Integrals),
      CHARS.ForFeature('h1', 'LM-M').minus(CHARSET.Arrows)
    ]],
    '-largeop': ['LM-M', [
      CHARS.ForFeature('v2', 'LM-M').minus(CHARSET.Ops, CHARSET.Arrows, CHARSET.Integrals),
      CHARS.ForFeature('h2', 'LM-M').minus(CHARSET.Arrows),
      CHARSET.Integrals.feature('v1'),
      CHARSET.Ops, CHARSET.Arrows,
    ]],
    '-size3': ['LM-M', [
      CHARS.ForFeature('v3', 'LM-M'),
      CHARS.ForFeature('h3', 'LM-M')
    ]],
    '-size4': ['LM-M', [
      CHARS.ForFeature('v4', 'LM-M'),
      CHARS.ForFeature('h4', 'LM-M')
    ]],
    '-size5': ['LM-M', [
      CHARS.ForFeature('v5', 'LM-M'),
      CHARS.ForFeature('h5', 'LM-M')
    ]],
    '-size6': ['LM-M', [
      CHARS.ForFeature('v6', 'LM-M'),
      CHARS.ForFeature('h6', 'LM-M')
    ]],
    '-size7': ['LM-M', [
      CHARS.ForFeature('v7', 'LM-M'),
      CHARS.ForFeature('h7', 'LM-M')
    ]],
    '-tex-mathit': ['LM-I', [
      CHARSET.Alpha
    ]],
    '-tex-calligraphic': ['LM-M', [
      CHARSET.ScriptToAlphaUC
    ]],
    '-tex-bold-calligraphic': ['LM-M', [
      CHARSET.BoldScriptToAlphaUC
    ]],
    '-tex-oldstyle': ['OLD-R', [
      CHARSET.Numbers
    ]],
    '-tex-bold-oldstyle': ['OLD-B', [
      CHARSET.Numbers
    ]],
    '-tex-variant': [
      ['LM-M', [
    ...
    '-lf-tp': ['LM-M', [
      ...
      CHARS.InRange(0x23B4, 0x23E1, 'LM-M', 'lft'),
    ...
    '-rt-bt': ['LM-M', [
      ...
      CHARS.InRange(0x23B4, 0x23E1, 'LM-M', 'rt'),
    ...
    fixIC: [
      ['-largeop', .33, CHARS.Range(0x222B, 0x2233).plus(CHARS.At(0x2A0C, 0x2A11))],
      ['normal', .12, CHARS.At(0x222B, 0x222C, 0x222D, 0x2A0C)],
      ['normal', .05, CHARS.At(0x222E, 0x222F, 0x2230)],
      ['normal', .02, CHARS.At(0x2231, 0x2232, 0x2233, 0x2A11)]
    ]
  });

  /***********************************************************************************/

  const MathJaxModernDelimiters = Delimiters.define({
    font: 'LM-M',
    variants: MathJaxModernVariants,
    sizeVariants: ['normal'],
  ...
  const MathJaxModernData: FontDef = {
    name: 'MathJaxModern',
    prefix: 'MM',
    variants: MathJaxModernVariants,
    delimiters: MathJaxModernDelimiters,
    ranges: [
      ...
      ['monospace-ex', {MX: {monospace: RANGES.EXTRA}}],
      ['calligraphic', {
      ...
      ['shapes', {
        ...
        SHI: {italic: [0x266A, 0x26AD, 0x26AE]},
        SHBI: {'bold-italic': [0x266A, 0x26AD, 0x26AE]}
      }],
      ['variants', {
  ...
  CommonFont.define(MathJaxModernData).writeFont();

  Components.define('svg', MathJaxModernData).writeFont().writeComponent();
  SVGFont.define(MathJaxModernData).writeFont();

  Components.define('chtml', MathJaxModernData).writeFont().writeComponent();
  CHTMLFont.define(MathJaxModernData).writeFont().makeWoffFonts('LM-M');
